...
foreach ( array( 'field_it_courses_catalog_card_image', 'field_it_courses_testimonials_image_4', 'field_course_card_image', 'field_course_project_student_image' ) as $field_key ) {
