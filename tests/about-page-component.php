...
if ( ! str_contains( $page, 'img/about/history-image.svg?ver=de68c1b' ) || ! is_file( get_template_directory() . '/assets/img/about/history-image.svg' ) ) {
	$errors[] = 'About history must use the source anniversary illustration.';
}
