...
$camp = get_page_by_path( 'camp-seasonal-fixture', OBJECT, 'camp' );
$camp_id = $camp ? (int) $camp->ID : (int) wp_insert_post( array( 'post_type' => 'camp', 'post_name' => 'camp-seasonal-fixture', 'post_title' => 'Тестовий табір', 'post_status' => 'publish' ) );
...
if ( $city && 'publish' !== $city->post_status ) {
