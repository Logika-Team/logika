...
final class ContentMigration {
	...
	private static function applyPage( string $kind, int $id ): void {
		...
		$seeds = match ( $kind ) {
			'about' => array(
					'about_hero_title' => self::legacy( $id, 'about_page_texts', 'Найбільша в Україні школа програмування та англійської мови для дітей 7-17 років' ),
					'about_hero_text' => self::legacy( $id, 'about_page_texts', 'Запишіться на безкоштовний пробний урок - онлайн або у вашому місті' ),
					'about_hero_image' => '@asset:about/hero-characters.svg',
					...
					'about_hero_cta_label' => 'Спробувати безкоштовно',
					'about_hero_consent_text' => 'Натискаючи, ви погоджуєтесь із',
					'about_hero_background_image' => '@asset:main-hero/main-hero-bg.svg',
					'about_hero_pattern_image' => '@asset:main-hero/main-pattern.svg',
					'about_hero_character_image' => '@asset:logika-character.svg',
				...
				'about_history_text' => '<p>Наша школа є успішним освітнім проєктом, який діє з 2018 року та має понад 50 000 випускників. Навчаємо дітей 7–17 років, заняття проводимо онлайн та офлайн. Маємо два напрямки: програмування та англійська мова.</p><p>Крім основного навчання проводимо сезонні інтелектуальні квести з призами, їздимо в IT-табори до Карпат та заохочуємо до навчання різноманітними способами.</p><strong>Наша основна мета – навчити цікаво, легко та ефективно!</strong>',
					'about_history_image' => '@asset:about/history-image.svg',
				...
				'about_onboarding_items' => array(
						array( 'title' => 'Залишіть заявку', 'text' => 'Заповніть форму — менеджер зв’яжеться та підбере зручний час.', 'cta_label' => 'Залишити заявку', 'image' => '@asset:onbording/onbording1.svg' ),
						array( 'title' => 'Відвідайте безкоштовний пробний урок', 'text' => 'Дитина спробує навчання без жодних зобов’язань.', 'cta_label' => 'Залишити заявку', 'image' => '@asset:onbording/onbording2.svg' ),
						array( 'title' => 'Розпочніть навчання', 'text' => 'Регулярні заняття, власні проєкти та відкриті уроки для батьків.', 'cta_label' => 'Залишити заявку', 'image' => '@asset:onbording/onbording3.svg' ),
					),
					'about_map_title' => $common['map_title'], 'about_map_text' => $common['map_text'], 'about_map_offline_label' => 'Навчатися у нашому місті', 'about_map_online_label' => 'Онлайн навчання', 'about_map_city_label' => 'Оберіть місто навчання',
					'about_cta_title' => $common['cta_title'], 'about_cta_subtitle' => $common['cta_subtitle'], 'about_cta_image' => $common['cta_image'], 'about_cta_submit_label' => 'Отримати консультацію', 'about_cta_consent_text' => 'Натискаючи, ви погоджуєтесь із', 'about_cta_character_image' => '@asset:cta/cta-icon.svg', 'about_cta_top_background_image' => '@asset:cta/cta-top-bg.svg', 'about_cta_bottom_background_image' => '@asset:cta/cta-bottom-bg.svg',
				'about_featured_reviews' => $reviews,
				'about_faq_title' => $common['faq_title'], 'about_featured_faq' => $faqs,
					'about_featured_posts' => $posts,
					'about_certificates_title' => 'Ура, подарункові сертифікати', 'about_certificates_subtitle' => 'Вартість сертифікату на 2 місяці навчання = вартість 1-го місяця + вартість 2-го місяця зі знижкою 10%', 'about_certificates_text' => "Залиште заявку, і ми зв'яжемось з вами: відповімо на будь-які запитання і допоможемо обрати курс", 'about_certificates_button_label' => 'Залишити заявку', 'about_certificates_image' => '@asset:certificates/certificate.png', 'about_certificates_background_image' => '@asset:certificates/certificates-bg.svg',
					'about_partners_title' => 'Наші партнери',
					'about_partners_items' => array_map( static fn( string $name ): array => array( 'name' => $name, 'image' => '@asset:Partners/' . $name . '.png' ), array( 'think', '1+1', 'Free', 'club', 'ed', 'basis', 'fond', 'mriya' ) ),
					'about_use_global_certificates' => 1, 'about_use_global_partners' => 1,
			),
			'it-courses' => array(
	...
	private static function applyCampArchive(): void {
		foreach ( array(
			...
			'camp_archive_benefits_title' => 'Табори з Logika - це:', 'camp_archive_benefits' => array( array( 'title' => 'Для дітей 10-16 років', 'image' => '@asset:camps/camps1.svg' ), array( 'title' => 'Формат All-inclusive', 'image' => '@asset:camps/camps2.svg' ), array( 'title' => 'Власні розважальні програми', 'image' => '@asset:camps/camps3.svg' ), array( 'title' => 'Працює своя команда вожатих', 'image' => '@asset:camps/camps4.svg' ), array( 'title' => 'Трансферти з великих міст', 'image' => '@asset:camps/camps5.svg' ), array( 'title' => 'Медичне страхування', 'image' => '@asset:camps/camps6.svg' ) ),
