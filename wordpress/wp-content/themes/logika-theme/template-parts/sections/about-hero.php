		...
		<div class="banner-section__wrapp">
			<div class="banner-section__blocks">
				<div class="banner-section__left">
					...
					<div class="banner-section__character-boy"><img width="432" height="232" src="<?php echo esc_url( $assets . '/about/hero-characters.svg' ); ?>" alt="Персонажі Logika Ctrl та W"></div>
				</div>
