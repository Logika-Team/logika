...
final class Logika_Theme_Article_Page {
	...
	private static function share( int $post_id ): void {
		...
		if ( ! $socials ) { return; }
		?> <div class="article-section__share"><p>Поділитися</p><ul class="share"><?php foreach ( $socials as $social ) : ?><li><?php if ( ! empty( $social['url'] ) ) : ?><a href="<?php echo esc_url( $social['url'] ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( $social['label'] ); ?>"><?php endif; ?><svg width="40" height="40" aria-label="<?php echo esc_attr( $social['label'] ); ?>"><use href="<?php echo esc_url( self::asset( 'img/sprite/sprite.svg#' . $social['icon'] ) ); ?>"></use></svg><?php if ( ! empty( $social['url'] ) ) : ?></a><?php endif; ?></li><?php endforeach; ?></ul></div><?php
	}
