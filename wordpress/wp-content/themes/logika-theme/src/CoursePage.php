...
final class Logika_Theme_Course_Page {
	public static function render( int $course_id ): string {
		...
		get_template_part( 'template-parts/sections/school-map', null, array( 'title' => get_field( 'course_map_title', $course_id ) ?: 'Знайдіть свою школу або навчайтесь онлайн', 'text' => get_field( 'course_map_text', $course_id ) ?: 'Оберіть зручний формат навчання.' ) );
